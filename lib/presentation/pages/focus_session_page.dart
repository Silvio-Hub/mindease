            ...
            child: BlocProvider(
              ...
              child: BlocBuilder<PomodoroCubit, PomodoroState>(
                builder: (ctx, pomodoro) {
                  final minutes = pomodoro.remaining.inMinutes
                      .remainder(60)
                      .toString()
                      .padLeft(2, '0');
                  final seconds = pomodoro.remaining.inSeconds
                      .remainder(60)
                      .toString()
                      .padLeft(2, '0');
                  return Column(
                      ...
                      Center(
                        child: TextButton(
                          ...
                          style: TextButton.styleFrom(
                            foregroundColor: Brand.primary.withValues(
                              alpha: 0.6,
                            ),
                          ),
